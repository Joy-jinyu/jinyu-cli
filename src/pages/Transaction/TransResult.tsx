...
import Icon, { ArrowDownOutlined, SwapRightOutlined } from '@ant-design/icons';
import { NavigateAddress } from '@';
import { transactionEnum, MINT, MINT_BATCH } from './ constants';
        ...
        <div>
            {
                nfrList.map((item, index) => {
                    ...
                    return (<div className="flow-wrap" key={item.id}>
