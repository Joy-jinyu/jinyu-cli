...
function Home() {
  const { countDetail, lastBlock, lastTransactions } = useSelector((state: any) => state.home)
    ...
    <div>
      <div className="search-content">
        <div className="search-content-left">
          <div className="title">
            <Image width={50} height={50} preview={false} src="cc.jpeg" />
            <span className="title-text">Free Blockchain Explorer</span>
          </div>
      ...
      <InfoList lastBlock={lastBlock} lastTransactions={lastTransactions} />
    </div>
  )
}
